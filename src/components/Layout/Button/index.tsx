...
const Button = styled(
  ...
  background: ${(props) => {
    ...
    if (props.mode === "success") return `${props.theme.colors.accent.green}`;
    ...
    if (props.mode === "alert") return `${props.theme.colors.accent.red}`;
  ...
  color: ${(props) => {
    ...
    return props.theme.colors.accent.white;
  }};
  ...
  border: ${(props) => {
    ...
    if (props.mode === "alert")
      return `1px solid ${props.theme.colors.accent.red}`;
    if (props.mode === "success")
      return `1px solid ${props.theme.colors.accent.green}`;
    ...
    return `1px solid ${props.theme.colors.accent.light}`;
  }};
